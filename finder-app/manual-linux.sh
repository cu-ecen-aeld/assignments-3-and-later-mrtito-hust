...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    git fetch origin
    # git format-patch -1 e33a814e772cdc36436c8c188d8c42d019fda639
    # git apply 0001-description-of-commit.patch
...
# '-a' option is used to preserve the permissions, ownership, timestamps and symbolic links (shorcuts) when copying.
